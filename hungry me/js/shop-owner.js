document.addEventListener('DOMContentLoaded', () => {
    ...
    let shops = [
        ...
        { id: 2, name: "Ciudad Elmina Restaurant", description: "Delicious meals delivered fast!", address: "28MV+PJQ, Road, Dagupan, Pangasinan", phone: "+1-555-123-4567", email: "ciudadelmina@email.com", hours: "Daily: 11 AM - 11 PM", status: "pending" },
        { id: 3, name: "Matutina-Gerry's Seafood House", description: "Delicious meals delivered fast!", address: "De Venecia Road, Dagupan City, Pangasinan", phone: "+1-555-789-1234", email: "tomsdiner@hungryme.com", hours: "Daily: 8 AM - 7:30 PM", status: "pending" }
    ];
