document.addEventListener('DOMContentLoaded', () => {
    ...
    // Sample shop data
    let shops = [
        { id: 1, name: "John’s Kitchen", description: "Delicious meals delivered fast!", address: "456 Food St, Springfield", phone: "+1-555-987-6543", email: "johnskitchen@hungryme.com", hours: "Mon-Sat: 10 AM - 10 PM", status: "pending" },
        { id: 2, name: "Mary’s Bakery", description: "Freshly baked goods daily!", address: "123 Bread Rd, Springfield", phone: "+1-555-123-4567", email: "marysbakery@hungryme.com", hours: "Mon-Fri: 8 AM - 6 PM", status: "approved" },
        { id: 3, name: "Tom’s Diner", description: "Classic diner experience!", address: "789 Main St, Springfield", phone: "+1-555-789-1234", email: "tomsdiner@hungryme.com", hours: "Daily: 7 AM - 9 PM", status: "pending" }
    ];
    ...
    window.approveShop = function(index, currentFilter) {
        ...
        if (shopTable.classList.contains('active')) {
            ...
            // Update the label after approving (reflect the new filter)
    ...
    window.deleteShop = function(index, currentFilter) {
        ...
        if (shopTable.classList.contains('active')) {
            ...
            // Update the label after deleting
            const activeBtn = document.querySelector('.filter-btn.active');
